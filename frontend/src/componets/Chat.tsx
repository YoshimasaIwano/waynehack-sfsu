...
export function Chat() {
  ...
  async function askDetail() {
    PARAMS.messages.push({
      role: 'user',
      content:
        "The final task as a cashier is to summarize the orders in list, and tell me the total bill in a format such as 'Total: $12.00'? NOTE THAT JUST GIVE ME A LIST. Don't say sure or something."
    });
    const response = await ChatGPT();
